...
<div class="container mt-5">
  ...
  <div class="container mt-1 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px skyblue;"> <!-------- container start ----------->
    ...
    <div class="col-md-12">
    <a href="index1.php" class="btn btn-primary">BACK</a><br /><br />
    <p class="text-center h5 text-danger">Enter following details for Take admission in 1<sup>st</sup> Year, 2<sup>nd</sup> Year and 3<sup>rd</sup> Year in engineering diploma</p><br />
    ...
    <input type="text" style="width:3%;padding:5px;border-radius:5px;border:1px solid #ccc;text-transform:uppercase;" class="ml-1" placeholder="" name="brn1" id="brn1" /><label for="ses" class="ml-2">/</label>
