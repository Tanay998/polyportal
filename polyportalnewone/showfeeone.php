...
#myBtn {
 ...
 -------------------------------------------------------------------------------------------------------------------------------------------------------
 ------------------------------------------- CONTAINER FLUID ONE ---------------------------------------------------------------------------------------> 
 <form action="FeeShowwhole.php" method="POST" enctype="multipart/form-data">
...
<div class="container mt-5">
  ...
  <div class="container mt-3 rounded p-3 mb-5" style="background-color:#D6F7F9;box-shadow:4px 9px 25px 4px skyblue;"> <!-------- container start ----------->
  
    <div class="col-md-12">
    <a href="feeshow.php" class="btn btn-primary">BACK</a><br /><br />
      <label for="Branch">Branch</label> <select class="form-control" name="Branch" id="Branch" >
          <option selected>*********** Select Branch to View whole Fee record *****************</option>
