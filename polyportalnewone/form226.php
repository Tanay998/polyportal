...
<html lang="en">
  ...
  <body onload="myFunction()">
   ...
   <?php include('header.php') ?>
        ...
        <form action="getinfo226.php" method="post" enctype="multipart/form-data">
            
        </div><!--- container fluid end --->

        <div class="container mt-4 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 10px grey;"><!--- container start --->
               <a href="add3.php" class="btn btn-danger">BACK</a><br /><br />
              ...
              <ul class="nav nav-tabs" id="myTab" role="tablist"><!-- tab menu start -->
                ...
                if($year==1){
                    $sql1 = "SELECT * FROM `record1` WHERE `AdmissionNo1`='$dateadd1' AND `AdmissionNo2`='$brn1' AND `RegNo`='$regNo1' AND `Year`='$year'";
                            ...
                            <div class="col-md-12"><!-- column start--->
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="AdmissionSession" id="AdmissionSession" onchange="transfer()">
                                            <option value="selectp">***** SELECT ADMISSION YEAR</option>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><!---- Personal Detail I Tab ---------->
                    ...
                    <div class="row mt-4"><!--------- row start--------->
                                    <div class="col-md-12"><!-- column start-->
                                        ...
                                        <input type="text" name="firstname" class="form-control" placeholder="Enter First Name" id="firstname" value="<?php echo $result1['First Name']; ?>" style="text-transform: uppercase;" />
                                    </div><!------ column end------>
                    </div><!-- row end -->
                    ...
                    <div class="row mt-4"><!--------- row start--------->
                                    <div class="col-md-12"><!-- column start-->
                                        ...
                                        <input type="text" name="middlename" class="form-control" placeholder="Enter middle Name" id="middlename" value="<?php echo $result1['Middle Name']; ?>" style="text-transform: uppercase;"/>
                                    </div><!------ column end------>
                    </div><!-- row end -->
                    ...
                    <div class="row mt-4"><!--------- row start--------->
                                    <div class="col-md-12"><!-- column start-->
                                        ...
                                        <input type="text" name="lastname" class="form-control" placeholder="Enter last Name" id="lastname" value="<?php echo $result1['Last Name']; ?>" style="text-transform: uppercase;"/>
                                    </div><!------ column end------>
                    </div><!-- row end -->
                    ...
                    <div class="row mt-4"><!--------- row start--------->
                                    <div class="col-md-12"><!-- column start------>
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter name in hindi" name="hindiname" id="hindiname" value="<?php echo $result1['Name in Hindi']; ?>" style="text-transform:uppercase;"/>
                                    </div><!-- row end -->
                    </div><!-- row end------>
                    ...
                    <div class="row mt-4"><!------- row start------>
                                    <div class="col-md-12"><!-- column start---->
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Father Name" name="fathername" id="fathername" value="<?php echo $result1['Father Name']; ?>" style="text-transform:uppercase;" />
                                    </div><!-- column end -->
                    </div><!-- row end -->
                    <div class="row mt-4"><!-------- row start---->
                                    <div class="col-md-12"><!-- column start---->
                                        <label for="hindiname1" class="text-dark">पिता का नाम (हिंदी में)</label>
                                        <input type="text" class="form-control" name="hindiname1" id="hindiname1" value="<?php echo $result1['Father Name in Hindi']; ?>" placeholder="Enter Father Name in Hindi" style="text-transform:uppercase;" />
                                    </div><!-- column end -->
                    </div><!-- row end -->
                    <div class="row mt-4"><!------ row start---->
                                    <div class="col-md-12"><!--column start------->
         ...
         <div class="tab-pane fade" id="upload" role="tabpanel" aria-labelledby="upload-tab"><!--Document Upload Tab Start-->
              <div class="row mt-4"><!--row start -->
                ...
                <button type="button" class="btn btn-success" name="edit" id="edit" onclick="release5()">EDIT</button></br><br />
                   <label for="profilepic" class="text-dark">प्रवेश पत्र  (Admit Card Picture)</label>
                   <input type="file" name="file" accept="image/*" id="file" class="form-control" onchange="loadFile(event);" />
                   <br />
                   <div><img id="output" name="output" width="150px" height="150px" src="<?php echo $result1['Admit Card Picture']; ?>" /></div>
              ...
              <div class="row mt-4"><!--row start-->
                <div class="col-md-12"> <!--column start-->
                   <label for="aadhaarCard" class="text-dark">आवंटन पत्र (AllotmentLetter)</label>
                   <input type="file" name="file1" accept="image/*" id="file1" class="form-control" onchange="loadFile1(event);" />
                   <br />
                   <div><img id="output1" name="output1" width="150px" height="150px" src="<?php echo $result1['AllotmentLetterPicture']; ?>" /></div>
                   <script type="text/javascript">
              ...
              <div class="row mt-4"> <!--row start-->
                <div class="col-md-12"> <!--column start-->
                   <label for="HighSchool" class="text-dark">अन्य शैक्षिक योग्ताएं   (Other Qualification)</label>
                   <input type="file" name="file2251" accept="image/*" id="file2251" class="form-control" onchange="loadFile2251(event);" />
                   <br />
                   <div><img id="output2251" name="output2251" width="150px" height="150px" src="<?php echo $result1['Other Qualification Picture']; ?>" /></div>
                   <script type="text/javascript">
              ...
              <div class="row mt-4"><!--row start-->
                <div class="col-md-12"> <!--column start-->
                   <label for="HighSchool" class="text-dark">गैप एफिडेविट   (Gap Affidavit)</label>
                   <input type="file" name="file2" accept="image/*" id="file2" class="form-control" onchange="loadFile2(event);" />
                   <br />
                   <div><img id="output2" name="output2" width="150px" height="150px" src="<?php echo $result1['Gap Affidavit Picture']; ?>" /></div>
                   <script type="text/javascript">
              ...
              <div class="row mt-4" id="inter1"><!--row start -->
                <div class="col-md-12"><!--column start-->
                   <label for="Intermediate" class="text-dark">चिकित्सा प्रमाण पत्र (Medical Certificate)</label>
                   <input type="file" name="file3351" accept="image/*" id="file3351" class="form-control" onchange="loadFile3351(event);" />
                   <br />
                   <div><img id="output3351" name="output3351" width="150px" height="150px" src="<?php echo $result1['Medical Certificate Picture']; ?>" /></div>
                   <script type="text/javascript">
...
if($year==2){
    $sql1 = "SELECT * FROM `record2` WHERE `AdmissionNo1`='$dateadd1' AND `AdmissionNo2`='$brn1' AND `RegNo`='$regNo1' AND `Year`='$year'";
    $query1 = mysqli_query($db,$sql1);
    while($result1=mysqli_fetch_array($query1)){
       ?>
...
<div class="tab-content" id="myTabContent">
       ...
       <?php 
            if($year==3){
                $sql1 = "SELECT * FROM `record3` WHERE `AdmissionNo1`='$dateadd1' AND `AdmissionNo2`='$brn1' AND `RegNo`='$regNo1' AND `Year`='$year'";
                $query1 = mysqli_query($db,$sql1);
                while($result1=mysqli_fetch_array($query1)){    
       ?>
