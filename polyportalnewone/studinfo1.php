  ...
  if(isset($_POST['submit']))
    {
        ...
        $max8 = $_POST['max81'];
        $obtained8 = $_POST['obtained81'];
        $max81= $_POST['max811'];
        $obtained82 = $_POST['obtained821'];
        $total83 = $_POST['total831'];
        $max9 = $_POST['max91'];
        ...
        $query1="INSERT INTO `sem2`(`StudentName`, `FatherName`, `RegistrationNo`, `RollNo`, `Date`, `Category`, `max11`, `obtained11`, `max111`, `obtained111`, `total121`, `max21`, `obtained21`, `max211`, `obtained211`, `total221`, `max31`, `obtained31`, `max311`, `obtained321`, `total331`, `max41`, `obtained41`, `max411`, `obtained421`, `total431`, `max51`, `obtained51`, `max511`, `obtained521`, `total531`, `max61`, `obtained61`, `max611`, `obtained621`, `total631`, `max71`, `obtained71`, `max711`, `obtained721`, `total731`, `max81`, `obtained81`, `max811`, `obtained821`, `total831`, `max91`, `obtained91`, `max911`, `obtained921`, `total931`, `grandtotal1`, `percentage1121`) VALUES ('$studname','$fathername','$regno','$rollno','$dateent','$category','$max1','$obtained1','$max11','$obtained11','$total12','$max2','$obtained2','$max21','$obtained21','$total22','$max3','$obtained3','$max31','$obtained32','$total33','$max4','$obtained4','$max41','$obtained42','$total43','$max5','$obtained5','$max51','$obtained52','$total53','$max6','$obtained6','$max61','$obtained62','$total63','$max7','$obtained7','$max71','$obtained72','$total73','$max8','$obtained8','$max81','$obtained82','$total83','$max9','$obtained9','$max91','$obtained92','$total93','$grandtotal','$percentage112')";
        if(mysqli_query($db,$query1))
        {
           ...
           echo "<script>
               ...
               {
                   location.replace('insertrecord2.php');
               }
           </script>";
