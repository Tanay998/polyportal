...
<html lang="en">
  ...
  <button class="btn btn-primary btn-lg" type="button" onclick="location.href='feeshow.php'">
    SHOW FEE 
  </button>

  <button class="btn btn-primary btn-lg ml-5" type="button" onclick="checkfunc();">
    ENTRY FEE
  </button>
...
<script>
		...
		if(person=="admin@123")
		{
			location.replace("feereport.php");
		}
	}
	</script>
    <!-- Optional JavaScript -->
