...
#myBtn {
 ...
 -------------------------------------------------------------------------------------------------------------------------------------------------------
 ------------------------------------------- CONTAINER FLUID ONE ---------------------------------------------------------------------------------------> 
 <form action="showdata21.php" method="POST" enctype="multipart/form-data">
...
<div class="container mt-5">
  ...
  <div class="container mt-1 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px skyblue;"> <!-------- container start ----------->
    ...
    <div class="col-md-12">
    <a href="record12.php" class="btn btn-primary">BACK</a><br /><br />
    <p class="text-center h2 text-success">VIEW ADMISSION SESSION INFORMATION</p><br>
