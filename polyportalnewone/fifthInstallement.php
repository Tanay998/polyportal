...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <form action="feeinfo5.php" method="POST">
        ...
        <p class="text-center h2 text-primary">FIFTH INSTALLEMENT</p>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                        <p class="text-center bg-primary p-2 text-white">V<sup>th</sup> Installement</p>
                            <label for="amt550">Fifth Installement</label>
                            <input type="text" name="FifthInstallement" id="amt550" class="form-control" placeholder="Enter fifth Installement" onkeyup="feetotals();" /><br />
                            <label for="amt5">Payable Amount By Student</label>
                            <input type="text" name="AmountStu5" id="amt5" class="form-control" placeholder="Enter fifth Installement" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate5" id="date5" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="date51">Due Date</label>
                            <input type="date" name="DueDate51" id="date51" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt151">Remaining Amount</label>
                            <input type="text" name="RemainingAmount51" id="amt151" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt15000">Total Payable Amount</label>
                            <input type="text" name="TotalAmount15" id="amt15000" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
  ...
  <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
    ...
    <script type="text/javascript">
        function feetotals() {
            document.getElementById('amt151').value =parseInt(document.getElementById('amt550').value)-parseInt(document.getElementById('amt5').value);
            document.getElementById('amt15000').value =parseInt(document.getElementById('amt550').value)-parseInt(document.getElementById('amt151').value);
        }
    </script>
  </body>
</html>