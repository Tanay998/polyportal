...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <form action="studinfo11.php" method="POST">

        <div class="container mt-5 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px grey;"><!--- container start --->
        <p class="text-center h2 text-primary">Electrical Engineering Semester 3</p>
               <a href="insertrecord3.php" class="btn btn-danger">BACK</a><br /><br />
               ...
               <li class="nav-item"><a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Fundamentals of Electrical Engineering</a></li>
               <li class="nav-item"><a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Electrical and Electronics Engineering Materials</a></li>
               <li class="nav-item"><a class="nav-link" id="person-tab" data-toggle="tab" href="#person" role="tab" aria-controls="person" aria-selected="false">Electronic Devices and Circuits</a></li>
               <li class="nav-item"><a class="nav-link" id="education-tab" data-toggle="tab" href="#education" role="tab" aria-controls="education" aria-selected="false">Fundamenals of Mechanical and Civil Engineering</a></li>
               <li class="nav-item"><a class="nav-link" id="upload-tab" data-toggle="tab" href="#upload" role="tab" aria-controls="upload" aria-selected="false">Electrical Measurements and Measuring Instruments</a></li>
               <li class="nav-item"><a class="nav-link" id="getting-tab" data-toggle="tab" href="#getting" role="tab" aria-controls="getting" aria-selected="false">Electrical Workshop Practice</a></li>
  ...
  <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
    ...
    <script type="text/javascript">
        function gettotals1() {
            ...
            document.getElementById('grandtotal1').value = parseInt(document.getElementById('total121').value) + parseInt(document.getElementById('total221').value) + parseInt(document.getElementById('total331').value) + parseInt(document.getElementById('total431').value) + parseInt(document.getElementById('total531').value) + parseInt(document.getElementById('total631').value) + parseInt(document.getElementById('total731').value)+ parseInt(document.getElementById('total931').value);
            document.getElementById('percentage1121').value=parseInt((document.getElementById('grandtotal1').value*100)/600);
