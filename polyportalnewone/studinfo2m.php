  ...
  if(isset($_POST['submit']))
    {
        ...
        $query1="INSERT INTO `sem3m`(`StudentName`, `FatherName`, `RegistrationNo`, `RollNo`, `Date`, `Category`, `max11m`, `obtained11m`, `max111m`, `obtained111m`, `total121m`, `max21m`, `obtained21m`, `max211m`, `obtained211m`, `total221m`, `max31m`, `obtained31m`, `max311m`, `obtained321m`, `total331m`, `max41m`, `obtained41m`, `max411m`, `obtained421m`, `total431m`, `max51m`, `obtained51m`, `max511m`, `obtained521m`, `total531m`, `max61m`, `obtained61m`, `max611m`, `obtained621m`, `total631m`, `max81m`, `obtained81m`, `max811m`, `obtained821m`, `total831m`, `grandtotal1m`, `percentage1121m`) VALUES ('$studname','$fathername','$regno','$rollno','$dateent','$category','$max1','$obtained1','$max11','$obtained11','$total12','$max2','$obtained2','$max21','$obtained21','$total22','$max3','$obtained3','$max31','$obtained32','$total33','$max4','$obtained4','$max41','$obtained42','$total43','$max5','$obtained5','$max51','$obtained52','$total53','$max6','$obtained6','$max61','$obtained62','$total63','$max8','$obtained8','$max81','$obtained82','$total83','$grandtotal','$percentage112')";
