...
<?php include('header.php') ?>
  ...
  <div class="container mt-5 rounded p-3 mb-5"> <!-------- container start ----------->
    <div class="row">
     <div class="col-md-12">
     <a href="FeeShow2.php" class="btn btn-primary" id="back7">BACK</a><br /><br />
     <a href="#" onclick="printpage()" style="text-decoration:none;" id="print7"><i class="fas fa-print" style="float:right;"></i></a>
      ...
      <?php 
        if(isset($_POST['submit']))
        {
          ...
          $query = "SELECT * FROM `feeinformation2` WHERE `StudentName`='$name' AND `FatherName`='$FatherName' AND `RegistrationNo`='$RegistrationNo'";
      ...
      <table class="table-borderless table-sm table-responsive">
        <tbody class="table-borderless">
          ...
          <tr>
            <td style="font-weight:bold;font-size:14px;background-color:#F8F9EC;">REGISTRATION NUMBER:</td>
            <td style="font-size:14px;background-color:#F8F9EC;"><?php echo $result['RegistrationNo']; ?></td>
          </tr>
          <tr>
...
<div class="row" >
  <div class="col-md-12">
  <a href="update12.php?studname=<?php echo $result['StudentName']; ?>" style="float:right;color:white;font-weight:bold;" class="btn btn-danger" id="update7">UPDATE RECORD</a><br/><br />
...
-------------------------------------------------------------------------------- OPTIONAL AND NEEDED JAVASCRIPT FILE ------------------------------------------------------------------------------------>    
    ...
    <script>
      function printpage()
      {
        ...
        var UpdateOne = document.getElementById("update7");
