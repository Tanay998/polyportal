...
------------------------------------------------------------------------- CONTAINER START ------------------------------------------------------------------------------------------------------------->
  ...
  <div class="container mt-4 rounded p-3 mb-5"> <!-------- container start ----------->
    <div class="row">
     <div class="col-md-12">
     <a href="marksheet_electrical_sem11_report.php" class="btn btn-primary" id="back11">BACK</a><br /><br />
     <a href="#" onclick="printpage()" style="text-decoration:none;" id="print11"><i class="fas fa-print" style="float:right;"></i></a>
      ...
      <table class="table-borderless table-sm table-responsive p-2" style="border:2px solid black;">
        <tbody class="table-borderless">
          ...
          <tr>
            <td style="font-weight:bold;font-size:14px;background-color:#FFFFFF;">STUDENT NAME:</td>
...
<div class="row" >
  <div class="col-md-12">
    <table class="table table-borderless table-sm table-responsive" style="padding:20px;margin-left:25%;border:none;">
      <tbody class="table-bordered-success p-2" style="border:2px solid black;">
        ...
        <tr class="table-bordered" style="background-color:#FFFFFF;">
  ...
  <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
    ...
    </div> <!----------------- container end -----------------><br /><br /><br /><br /><br />
