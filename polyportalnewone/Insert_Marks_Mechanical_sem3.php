...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <form action="studinfo2m.php" method="POST">

        <div class="container mt-5 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px grey;"><!--- container start --->
        <p class="text-center h2 text-primary">Mechanical Engineering Semester 3</p>            
               <a href="marks.php" class="btn btn-danger">BACK</a><br /><br />
               ...
               <li class="nav-item"><a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Applied Mechanics</a></li>
               <li class="nav-item"><a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Material Science and Matallurgy</a></li>
               <li class="nav-item"><a class="nav-link" id="person-tab" data-toggle="tab" href="#person" role="tab" aria-controls="person" aria-selected="false">Workshop Technology</a></li>
               <li class="nav-item"><a class="nav-link" id="education-tab" data-toggle="tab" href="#education" role="tab" aria-controls="education" aria-selected="false">Machine Drawing</a></li>
               <li class="nav-item"><a class="nav-link" id="upload-tab" data-toggle="tab" href="#upload" role="tab" aria-controls="upload" aria-selected="false">Thrmodynamics</a></li>
               <li class="nav-item"><a class="nav-link" id="getting-tab" data-toggle="tab" href="#getting" role="tab" aria-controls="getting" aria-selected="false">Basic Electrical and Electronics Technology</a></li>
                ...
                <div class="tab-pane fade" id="person" role="tabpanel" aria-labelledby="person-tab"><!---- Personal Detail III tab start-------->
                      ...
                      <div class="row mt-4"><!---- row start-------->
                                    ...
                                    <p class="text-center bg-primary p-2 text-white">Practical Marks</p>
                                        ...
                                        <input type="text" id="max311m" class="form-control" name="max311m" placeholder="Enter Maximum Marks" />
                                    </div><!-- row end ------->
                      </div><!-- row end --> 
