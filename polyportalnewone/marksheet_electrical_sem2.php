...
<?php include('header.php') ?>
  ...
  <div class="container mt-4 rounded p-3 mb-5"> <!-------- container start ----------->
    <div class="row">
     <div class="col-md-12">
     <a href="marksheet_electrical_sem2_report.php" class="btn btn-primary" id="back12">BACK</a><br /><br />
     <a href="#" onclick="printpage()" style="text-decoration:none;" id="print12"><i class="fas fa-print" style="float:right;"></i></a>
      ...
      <?php 
        ...
        {
          $rollno = $_POST['rollno'];
          $query = "SELECT * FROM `sem2` WHERE `RollNo`='$rollno'";
  ...
  <div class="col-md-12">
    <table class="table table-borderless table-sm table-responsive" style="padding:20px;margin-left:25%;border:none;">
      <tbody class="table-bordered-success" style="border:2px solid black;">
        ...
        <tr class="table-bordered" style="border:2px solid black;background-color:#FFFFFF;">
          <td style="font-size:12px;border:2px solid black;">992002 - APPLIED MATHEMATICS - II</td>
        ...
        <tr class="table-bordered" style="border:2px solid black;background-color:#FFFFFF;">
          ...
          <td style="border:2px solid black;"><?php echo $result['obtained81']; ?></td>
          <td style="border:2px solid black;"><?php echo $result['max811']; ?></td>
          <td style="border:2px solid black;"><?php echo $result['obtained821']; ?></td>
          <td style="border:2px solid black;"><?php echo $result['total831']; ?></td>
        </tr>
        <tr class="table-bordered" style="border:2px solid black;background-color:#FFFFFF;">
