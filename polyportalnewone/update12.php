...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <p class="text-center h2 text-primary">Fee Details</p><br/>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <?php
                        ...
                        $qu="SELECT *FROM `feeinformation2` WHERE `StudentName`='$stdname'";
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                        <p class="text-center bg-primary p-2 text-white">II<sup>nd</sup> Installement</p>
                            <label for="amt200">Second Installement</label>
                            <input type="text" name="SecondInstallement" id="amt200" class="form-control" placeholder="Enter IInd Installement" value="<?php echo $res['SecondInstallement']; ?>"onkeyup="feetotals();" /><br />
                            <label for="amt1">Payable Amount By Student</label>
                            <input type="text" name="AmountStu2" id="amt1" class="form-control" placeholder="Enter First Installement" value="<?php echo $res['AmountStu2']; ?>" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate2" id="date1" class="form-control" value="<?php echo $res['AmDate2']; ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="DueDate21" id="date2" class="form-control" value="<?php echo $res['DueDate21'] ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt111">Remaining Amount</label>
                            <input type="text" name="RemainingAmount21" id="amt111" class="form-control" value="<?php echo $res['RemainingAmount21']; ?>" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="text" name="TotalAmount11" id="amt1000" class="form-control" value="<?php echo $res['TotalAmount11']; ?>"placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                        <?php   
                                }
                        ?>
