...
<body>
    ...
    <form action="updateAdmitCard.php" method="post" enctype="multipart/form-data">
        <div class="container mt-4 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px green;"><!--- container start --->
               <a href="admitCard.php" class="btn btn-danger">BACK</a> <br /> <br />
               <?php 
                    ...
                    $year = $_POST['year'];
                    if($year ==1){
                    $sql1 = "SELECT * FROM `record1` WHERE `Course`='$Course' AND `RegNo`='$RegNo' AND `Year`='$year'";
               ...
               <?php
                        ...
                        $sql1 = "SELECT * FROM `record2` WHERE `Course`='$Course' AND `RegNo`='$RegNo' AND `Year`='$year'";
                    $query1 = mysqli_query($db,$sql1);
                    while($result1=mysqli_fetch_array($query1)){
                    ?>
                    <div class="row"><!--- row start --->
               ...
               <?php
                        ...
                        $sql1 = "SELECT * FROM `record3` WHERE `Course`='$Course' AND `RegNo`='$RegNo' AND `Year`='$year'";
                        $query1 = mysqli_query($db,$sql1);
                        while($result1=mysqli_fetch_array($query1)){
               ?>
               <div class="row"><!--- row start --->
