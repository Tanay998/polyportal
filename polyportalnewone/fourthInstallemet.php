...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <form action="feeinfo4.php" method="POST">
        ...
        <p class="text-center h2 text-primary">FOURTH INSTALLEMENT</p>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                        <p class="text-center bg-primary p-2 text-white">IV<sup>th</sup> Installement</p>
                            <label for="amt440">Fourth Installement</label>
                            <input type="text" name="FourthInstallement" id="amt440" class="form-control" placeholder="Enter fourth Installement" onkeyup="feetotals();" /><br />
                            <label for="amt4">Payable Amount By Student</label>
                            <input type="text" name="AmountStu4" id="amt4" class="form-control" placeholder="Enter fourth Installement" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate4" id="date4" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="date41">Due Date</label>
                            <input type="date" name="DueDate41" id="date41" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt141">Remaining Amount</label>
                            <input type="text" name="RemainingAmount41" id="amt141" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt14000">Total Payable Amount</label>
                            <input type="text" name="TotalAmount14" id="amt14000" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
  ...
  <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
    ...
    <script type="text/javascript">
        function feetotals() {
            document.getElementById('amt141').value =parseInt(document.getElementById('amt440').value)-parseInt(document.getElementById('amt4').value);
            document.getElementById('amt14000').value =parseInt(document.getElementById('amt440').value)-parseInt(document.getElementById('amt141').value);
        }
    </script>
  </body>
</html>