...
<?php include('header.php') ?>
  ...
  <div class="container mt-5 rounded p-3 mb-5"> <!-------- container start ----------->
    <div class="row">
     <div class="col-md-12">
     <a href="FeeShow4.php" class="btn btn-primary" id="back5">BACK</a><br /><br />
     <a href="#" onclick="printpage()" style="text-decoration:none;" id="print5"><i class="fas fa-print" style="float:right;"></i></a>
      <hr />
      <?php 
        if(isset($_POST['submit']))
        {
          ...
          $query = "SELECT * FROM `feeinformation4` WHERE `StudentName`='$studentname' AND `FatherName`='$FatherName' AND `RegistrationNo`='$RegistrationNo'";
...
<div class="row" >
  <div class="col-md-12">
  <a href="update14.php?studname=<?php echo $result['StudentName']; ?>" style="float:right;color:white;font-weight:bold;" class="btn btn-danger" id="update5">UPDATE RECORD</a><br /><br />
    <table class="table  table-sm table-responsive" style="padding:20px;background-color:#F8F9EC;margin-left:0.5%;">
      <tbody class="table-bordered-success">
        ...
        <tr class="table-bordered bg-primary text-white">
...
-------------------------------------------------------------------------------- OPTIONAL AND NEEDED JAVASCRIPT FILE ------------------------------------------------------------------------------------>    
    ...
    <script>
      function printpage()
      {
        var BackButton = document.getElementById("back5");
        var PrintOne = document.getElementById("print5");
        var UpdateOne = document.getElementById("update5");
