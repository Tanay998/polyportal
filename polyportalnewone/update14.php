...
<html lang="en">
  ...
  <?php include('header.php') ?>
        <form action="updateinfo4.php" method="POST">
        ...
        <p class="text-center h2 text-primary">Fee Details</p>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <?php
                        ...
                        $qu="SELECT *FROM `feeinformation4` WHERE `StudentName`='$stdname'";
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                        <p class="text-center bg-primary p-2 text-white">IV<sup>rd</sup> Installement</p>
                            <label for="amt200">Fourth Installement</label>
                            <input type="text" name="FourthInstallement" id="amt200" class="form-control" placeholder="Enter IVth Installement" value="<?php echo $res['FourthInstallement']; ?>"onkeyup="feetotals();" /><br />
                            <label for="amt1">Payable Amount By Student</label>
                            <input type="text" name="AmountStu4" id="amt1" class="form-control" placeholder="Enter Fourth Installement" value="<?php echo $res['AmountStu4']; ?>" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate4" id="date1" class="form-control" value="<?php echo $res['AmDate4']; ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="DueDate41" id="date2" class="form-control" value="<?php echo $res['DueDate41'] ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt111">Remaining Amount</label>
                            <input type="text" name="RemainingAmount41" id="amt111" class="form-control" value="<?php echo $res['RemainingAmount41']; ?>" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="text" name="TotalAmount14" id="amt1000" class="form-control" value="<?php echo $res['TotalAmount14']; ?>"placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                        <?php   
                                }
                        ?>
