...
<html lang="en">
  ...
  <body>
   ...
   <?php include('header.php') ?>
        ...
        <form name="form" action="physicalCertificateshow.php" id="form" method="post" enctype="multipart/form-data">
        ...
        <div class="container mt-4 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 10px grey;"><!--- container start --->
              ...
              <div class="row"><!----- row start------>
                ...
                <p class="text-center h3">PHYSICAL DISABILITY CERTIFICATE UPDATE</p>
