...
<html lang="en">
  ...
  <?php include('header.php') ?>
        <form action="updateinfo3.php" method="POST">
        ...
        <p class="text-center h2 text-primary">Fee Details</p>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <?php
                        ...
                        $qu="SELECT *FROM `feeinformation3` WHERE `StudentName`='$stdname'";
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                        <p class="text-center bg-primary p-2 text-white">III<sup>rd</sup> Installement</p>
                            <label for="amt200">Third Installement</label>
                            <input type="text" name="ThirdInstallement" id="amt200" class="form-control" placeholder="Enter IIIrd Installement" value="<?php echo $res['ThirdInstallement']; ?>"onkeyup="feetotals();" /><br />
                            <label for="amt1">Payable Amount By Student</label>
                            <input type="text" name="AmountStu3" id="amt1" class="form-control" placeholder="Enter Third Installement" value="<?php echo $res['AmountStu3']; ?>" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate3" id="date1" class="form-control" value="<?php echo $res['AmDate3']; ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="DueDate31" id="date2" class="form-control" value="<?php echo $res['DueDate31'] ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt111">Remaining Amount</label>
                            <input type="text" name="RemainingAmount31" id="amt111" class="form-control" value="<?php echo $res['RemainingAmount31']; ?>" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="text" name="TotalAmount13" id="amt1000" class="form-control" value="<?php echo $res['TotalAmount13']; ?>"placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                        <?php   
                                }
                        ?>
