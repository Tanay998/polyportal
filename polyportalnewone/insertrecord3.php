...
#myBtn {
 ...
 -------------------------------------------------------------------------------------------------------------------------------------------------------
 ------------------------------------------- CONTAINER FLUID ONE ---------------------------------------------------------------------------------------> 
 <form action="Insert_Marks_electrical_sem3.php" method="POST" enctype="multipart/form-data">
...
<div class="container mt-5">
  ...
  <div class="container mt-1 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px skyblue;"> <!-------- container start ----------->
    ...
    <p class="text-center h2 text-primary">Electrical Engineering Semester 3</p><br /><br />
