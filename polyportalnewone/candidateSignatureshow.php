...
<body>
    ...
    <form action="updateCandidateSignature.php" method="post" enctype="multipart/form-data">
        <div class="container mt-4 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px green;"><!--- container start --->
               <a href="candidateSignature.php" class="btn btn-danger">BACK</a> <br /> <br />
               <?php 
               ...
               <div class="row"><!--- row start --->
                ...
                <label for="HighSchool" class="text-dark">उम्मीदवार के हस्ताक्षर  <br/>CANDIDATE SIGNATURE</label>
