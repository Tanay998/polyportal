               ...
               <p class="h5 text-center">प्रवेश हेतु आवेदन पत्र 20
                        <input type="text" name="t1" id="t1" style="width:45px;border:none;border-radius:4px;" disabled
                            <?php 
                                ...
                                $pname=$_GET['pname'];
                                $pcourse=$_GET['pcourse'];
                                $query = "SELECT * FROM `record` WHERE `First Name`='$pname' AND `Course`='$pcourse'";
               ...
               <table class="table-borderless table-sm table-responsive">
                   <tbody>
                       ...
                       <tr class="table-bordered" style="border:2px solid #060606;">
                           ...
                           <td style="border:2px solid #060606;"><?php echo $result['Father Name']; ?></td>
                       </tr>
                       <tr class="table-border" style="border:2px solid #060606;">
                       ...
                       <tr class="table-bordered" style="border:2px solid #060606;">
                           ...
                           <td style="border:2px solid #060606;"><?php echo $result['Mother Name']; ?></td>
                       </tr>
                       <tr class="table-bordered" style="border:2px solid #060606;">
                       ...
                       <tr class="table-bordered" style="border:2px solid #060606;">
                        ...
                        <tr class="table-bordered" id="idone" style="border:2px solid #060606;">
                            <td width="15%" style="border:2px solid #060606;">Form Submitted By:</td>
                            <?php 
                            $pname=$_GET['pname'];
                            $query1="SELECT * FROM `record` WHERE `First Name`='$pname'";
                            $q1=mysqli_query($db,$query1) or die(mysqli_error($db));
                            while($result2=mysqli_fetch_array($q1)){
                           ?>
                           <td style="border:2px solid #060606;" colspan="2"><?php echo $result2['username'] ?>
                                <?php  
                                    }
                                ?>
                            </td>
