...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <form action="feeinfo1.php" method="POST">
        ...
        <p class="text-center h2 text-primary">FIRST INSTALLEMENT</p>
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        ...
                        <p class="text-center bg-primary p-2 text-white">I<sup>st</sup> Installement</p>
                            ...
                            <input type="text" name="FirstInstallement" id="amt200" class="form-control" placeholder="Enter Ist Installement" onkeyup="feetotals();" /><br />
                            <label for="amt1">Payable Amount By Student</label>
                            <input type="text" name="AmountStu1" id="amt1" class="form-control" placeholder="Enter First Installement" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate1" id="date1" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="DueDate1" id="date2" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt111">Remaining Amount</label>
                            <input type="text" name="RemainingAmount1" id="amt111" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="text" name="TotalAmount1" id="amt1000" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row">
