...
<?php include('header.php') ?>
  ...
  <div class="container mt-5 rounded p-3 mb-5"> <!-------- container start ----------->
    <div class="row">
     <div class="col-md-12">
     <a href="FeeShow5.php" class="btn btn-primary" id="back2">BACK</a><br /><br />
     <a href="#" onclick="printpage()" style="text-decoration:none;" id="print2"><i class="fas fa-print" style="float:right;"></i></a>
      <hr />
      <?php 
        if(isset($_POST['submit']))
        {
          ...
          $query = "SELECT * FROM `feeinformation5` WHERE `StudentName`='$name' AND `FatherName`='$FatherName' AND `RegistrationNo`='$RegistrationNo'";
...
<div class="row" >
  <div class="col-md-12">
  <a href="update15.php?studname=<?php echo $result['StudentName']; ?>" style="float:right;color:white;font-weight:bold;" class="btn btn-danger" id="update2">UPDATE RECORD</a><br /><br />
...
-------------------------------------------------------------------------------- OPTIONAL AND NEEDED JAVASCRIPT FILE ------------------------------------------------------------------------------------>    
    ...
    <script>
      function printpage()
      {
        ...
        var PrintOne = document.getElementById("print2");
        var UpdateOne = document.getElementById("update2");
