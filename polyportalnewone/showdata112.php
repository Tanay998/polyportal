  ...
  <?php include('header.php') ?>
        ...
        <div class="container mt-4 rounded p-3 mb-5" style="box-shadow:4px 9px 25px 4px grey;"><!--- container start --->
               ...
               <table class="table-borderless table-sm table-responsive">
                   <tbody class="table-borderless">
                       <tr class="table-bordered" style="border:2px solid #060606;">
                        ...
                        <td style="width:18%;border:2px"> <label for="Admission" class="text-dark">Admission No - ESTC / POLY /</label><?php echo $result['AdmissionNo1']; ?>/ <?php echo $result['AdmissionNo2']; ?> / <?php echo $result['RegNo']; ?></td>
                       </tr>
                       <tr class="table-bordered" style="border:2px solid #060606;">
               ...
               <?php
                                    ...
                                    else if($psem=="Sem3" || $psem=="Sem4")
                                    {

                                        $query = "SELECT * FROM `record2` WHERE `First Name`='$pname' AND `Semester`='$psem'";
                                $q=mysqli_query($db,$query) or die(mysqli_error($db));
                                while($result=mysqli_fetch_array($q)){
                                ?>
...
value="<?php echo $result['FromYear']?>">
               ...
               <table class="table-borderless table-sm table-responsive">
                   <tbody class="table-borderless">
                       <tr class="table-bordered" style="border:2px solid #060606;">
                        <td style="width:15%;" style="border:2px solid #060606;"><label for="Jeep" class="mt-2 text-dark" style="font-size:14px;">जीप रैंक (प्रथम वर्ष  के छात्र / छात्रा हेतु )<br/>JEEP RANK (FIRST YEAR / FOR  CANDIDATE)</label></td>
                        <td style="width:10%;" style="border:2px solid #060606;"><?php echo $result['JeepRank'];    ?></td>
                        <td style="width:18%;" style="border:2px solid #060606;"> <label for="Admission" class="text-dark">Admission No - ESTC / POLY /</label><?php echo $result['AdmissionNo1']; ?>/ <?php echo $result['AdmissionNo2']; ?> / <?php echo $result['RegNo']; ?></td>
                       </tr>
                       <tr class="table-bordered" style="border:2px solid #060606;">
                           <td style="width:15%;" style="border:2px solid #060606;"><label for="Roll" class="mt-2 text-dark" style="font-size:14px;">जीप अनुक्रमांक  (प्रथम वर्ष  के छात्र / छात्रा हेतु )<br/>JEEP ROLL (FIRST YEAR / FOR  CANDIDATE)</label></td>
                           <td style="border:2px solid #060606;"><?php echo $result['JeepRollNo']; ?></td>
                           <?php 
                            $pname=$_GET['pname'];
                            $query1="SELECT * FROM `record` WHERE `First Name`='$pname'";
               ...
               <?php
                                    ...
                                    else if($psem=="Sem5" || $psem="Sem6")
                                    {

                                        $query = "SELECT * FROM `record3` WHERE `First Name`='$pname' AND `Semester`='$psem'";
                                $q=mysqli_query($db,$query) or die(mysqli_error($db));
                                while($result=mysqli_fetch_array($q)){
