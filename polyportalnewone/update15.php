...
<html lang="en">
  ...
  <?php include('header.php') ?>
        <form action="updateinfo5.php" method="POST">
        ...
        <p class="text-center h2 text-primary">Fee Details</p>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <?php
                        ...
                        $qu="SELECT *FROM `feeinformation5` WHERE `StudentName`='$stdname'";
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        ...
                        <p class="text-center bg-primary p-2 text-white">V<sup>th</sup> Installement</p>
                            <label for="amt200">Fifth Installement</label>
                            <input type="text" name="FifthInstallement" id="amt200" class="form-control" placeholder="Enter Vth Installement" value="<?php echo $res['FifthInstallement']; ?>"onkeyup="feetotals();" /><br />
                            <label for="amt1">Payable Amount By Student</label>
                            <input type="text" name="AmountStu5" id="amt1" class="form-control" placeholder="Enter Fifth Installement" value="<?php echo $res['AmountStu5']; ?>" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate5" id="date1" class="form-control" value="<?php echo $res['AmDate5']; ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="DueDate51" id="date2" class="form-control" value="<?php echo $res['DueDate51'] ?>" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt111">Remaining Amount</label>
                            <input type="text" name="RemainingAmount51" id="amt111" class="form-control" value="<?php echo $res['RemainingAmount51']; ?>" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="text" name="TotalAmount15" id="amt1000" class="form-control" value="<?php echo $res['TotalAmount15']; ?>"placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                        <?php   
                                }
                        ?>
