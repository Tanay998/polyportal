...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <form action="feeinfo2.php" method="POST">
        ...
        <p class="text-center h2 text-primary">SECOND INSTALLEMENT</p>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                        <p class="text-center bg-primary p-2 text-white">II<sup>st</sup> Installement</p>
                            <label for="amt220">Second Installement</label>
                            <input type="text" name="SecondInstallement" id="amt220" class="form-control" placeholder="Enter IInd Installement" onkeyup="feetotals();" /><br />
                            <label for="amt2">Payable Amount By Student</label>
                            <input type="text" name="AmountStu2" id="amt2" class="form-control" placeholder="Enter First Installement" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate2" id="date2" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="date21">Due Date</label>
                            <input type="date" name="DueDate21" id="date21" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt121">Remaining Amount</label>
                            <input type="text" name="RemainingAmount21" id="amt121" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt11000">Total Payable Amount</label>
                            <input type="text" name="TotalAmount11" id="amt11000" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
  ...
  <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
    ...
    <script src="js/autoId.js"></script>
    <script src="js/displaydata.js"></script>
    <script type="text/javascript" src="js/gtransapi.js"></script>  
    <script type="text/javascript" src="js/translator.js"></script>
    <script type="text/javascript">
        function feetotals() {
            document.getElementById('amt121').value =parseInt(document.getElementById('amt220').value)-parseInt(document.getElementById('amt2').value);
            document.getElementById('amt11000').value =parseInt(document.getElementById('amt220').value)-parseInt(document.getElementById('amt121').value);
        }
    </script>
  </body>
</html>