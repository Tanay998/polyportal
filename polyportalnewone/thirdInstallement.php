...
<html lang="en">
  ...
  <?php include('header.php') ?>
        ...
        <form action="feeinfo3.php" method="POST">
        ...
        <p class="text-center h2 text-primary">THIRD INSTALLEMENT</p>
               ...
               <div class="tab"><!-- tab menu start -->
                ...
                <div id="Paris" class="tabcontent"><!---- Personal Detail I Tab ---------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                        <p class="text-center bg-primary p-2 text-white">III<sup>st</sup> Installement</p>
                            <label for="amt330">Third Installement</label>
                            <input type="text" name="ThirdInstallement" id="amt330" class="form-control" placeholder="Enter IIIrd Installement" onkeyup="feetotals();" /><br />
                            <label for="amt2">Payable Amount By Student</label>
                            <input type="text" name="AmountStu3" id="amt3" class="form-control" placeholder="Enter First Installement" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
                    ...
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            ...
                            <input type="date" name="AmDate3" id="date3" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="date31">Due Date</label>
                            <input type="date" name="DueDate31" id="date31" class="form-control" placeholder="Enter date" /><br /><br />     
                        </div><!-- column end---->
                    </div><!-----row end------->
                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt131">Remaining Amount</label>
                            <input type="text" name="RemainingAmount31" id="amt131" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->

                    <div class="row"><!--- row start------->
                        <div class="col-md-12"><!-- column start---->
                            <label for="amt13000">Total Payable Amount</label>
                            <input type="text" name="TotalAmount13" id="amt13000" class="form-control" placeholder="Enter Remaining Amount" onkeyup="feetotals();" /><br />    
                        </div><!-- column end---->
                    </div><!-----row end------->
  ...
  <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
    ...
    <script type="text/javascript">
        function feetotals() {
            document.getElementById('amt131').value =parseInt(document.getElementById('amt330').value)-parseInt(document.getElementById('amt3').value);
            document.getElementById('amt13000').value =parseInt(document.getElementById('amt330').value)-parseInt(document.getElementById('amt131').value);
        }
    </script>
  </body>
</html>